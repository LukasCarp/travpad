...
// The body of the marketing/About content — shared between the standalone
// /about page (for SEO + sharing) and the in-app About drawer (opened from
// the Info button on the map). Headers, footers, and sticky chrome live
// at the call sites, not in here.
